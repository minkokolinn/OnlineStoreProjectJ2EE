...
<section class="product_section layout_padding">
	<div class="container">
		...
		<div class="row">
			<%
			List<Product> recommendedproducts = new ProductDao().getRecommended3();
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div class="box">
					...
					<div class="img-box">
						<img src="productImg/<%=p.getImage() %>" alt="">
					</div>
	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<div
				...
				<%=cat.getCategory()%>
				<span class="badge badge-danger badge-pill"><%=cat.getProducts().size()%></span>
			</div>
			<%
			}
			}
